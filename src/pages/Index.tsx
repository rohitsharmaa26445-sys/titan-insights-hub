...
const Index = () => {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-background">
      ...
      {/* Main content — stacks on mobile, grid on md+ */}
      <main className="flex-1 flex flex-col md:grid md:grid-cols-12 gap-3 md:gap-4 p-3 md:p-4 min-h-0 overflow-y-auto md:overflow-hidden">
        {/* Left — Strategic Feed */}
        <div className="md:col-span-8 min-h-0 flex-shrink-0 md:flex-shrink">
          <StrategicFeed />
        </div>
